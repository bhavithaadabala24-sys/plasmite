  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-5">
      ...
      <button
        type="submit"
        disabled={loading}
        className="flex h-11 w-full items-center justify-center gap-2 rounded-lg bg-primary font-label-md font-medium text-on-primary shadow-md transition-all hover:bg-tertiary disabled:opacity-70"
      >
        {loading ? (
          <>
